package com.alpacaflow.meditrack.organization.seniorcitizen.interfaces.rest.resources.request;
...
@Schema(description = "Payload to update an existing senior citizen")
public record UpdateSeniorCitizenRequest(
        @NotBlank(message = "firstName is required")
        @Schema(example = "Maria") String firstName,

        @NotBlank(message = "lastName is required")
        @Schema(example = "Quispe Salas") String lastName,
        ...
        @Schema(example = "63.0") Double weight,
        ...
        @Schema(example = "5001") Long deviceId
) {
}
